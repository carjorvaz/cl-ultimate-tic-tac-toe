...
Vendored from htmx-ext-sse 2.2.4:
https://cdn.jsdelivr.net/npm/htmx-ext-sse@2.2.4/dist/sse.js
SHA-256: 3b5992a541619babefc4c169505af474df5c3039da51e59b96ccf9241ecd61d2
Upstream repository: https://github.com/bigskysoftware/htmx-extensions
*/
...
(function() {
  ...
  function ensureEventSource(elt, url, retryCount) {
    ...
    source.onerror = function(err) {
      // Normal finite event-stream responses end with an EventSource error before
      // the browser reconnects. Avoid routing that expected reconnect path through
      // htmx's console.error-backed error hook; real disconnects still reconnect
      // below and node-removal cleanup still runs.
